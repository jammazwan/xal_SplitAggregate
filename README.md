...
Functionality: **_Splitting and aggregating back in the same call_**
...
git clone https://github.com/jammazwan/xal_SplitAggregate.git
cd jammazwan.shared
mvn install 
```
...
_run XalTest to explore the options. NOTES.md is the actual doc on this project._
...
so you can focus only on what is required to demo the **SplitAggregate** feature **_in isolation_**.
...
The prefix **xal** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
